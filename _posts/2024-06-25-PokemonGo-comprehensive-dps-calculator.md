...
본 글의 레이드 성능표는 레이드 또는 체육관 배틀 상황에서의 일반적인 포켓몬 성능을 알아보기에 유용합니다. 게임프레스의 DPS 계산 공식[^analysis][^original]을 통해 평가되었으며 다음을 가정하고 있습니다. 보스를 설정한 성능은 [PoGo Sim (레이드 시뮬레이션)](https://pogoraidsim.com)에서 확인할 수 있습니다.
