...
tags: [조코딩, 코딩, 포켓몬고]
image:
    path: /assets/img/preview-jocoding-vibe.png
---

조코딩 강의를 들으며 만들고 있는 애플리케이션이다.

주제는 포켓몬고 레이드 시뮬레이션인데, 바이브 코딩을 처음 해보니 재밌지만 쉽지 않은 부분이 꽤 있었다.

마친 Google AI Pro를 구독중이라 gemini-cli를 이용했는데
...
- 조코딩, AI Product Builder 1주차, [link](https://www.youtube.com/watch?v=-iEIOXh9DCs&t=24215s)
